      ...
      <TABLE BORDER="1" ALIGN="center" BORDERCOLOR="black">
       <FORM ACTION="admin_clanky_update.php?x=3" METHOD="post">
        ...
        <? if ( $_SESSION['typ_uzivatela'] == "admin" ) {?>
          <TR><TD ALIGN="center"><B>AUTOR:</B><BR><INPUT TYPE="text" NAME="author" SIZE="65" MAXLENGTH="128" VALUE="<? echo $vytiahnutie['autor'] ?>"></TD></TR>
        <? } 
         if ( $_SESSION['typ_uzivatela'] == "moderator" ) {?>
           <TR><TD ALIGN="center"><B>AUTOR:</B><BR><INPUT TYPE="hidden" NAME="author" SIZE="65" MAXLENGTH="128" VALUE="<? echo $vytiahnutie['autor']; ?>"><? echo $_SESSION['meno_uzivatela']; ?></TD></TR>
         <? } ?>
        
        <TR><TD ALIGN="center"><B>NADPIS CLANKU:</B><BR><INPUT TYPE="text" NAME="nadpis" SIZE="65" MAXLENGTH="128" VALUE="<? echo $vytiahnutie['nadpis']; ?>"></TD></TR>
        <TR><TD ALIGN="center"><B>DATUM (DD-MM-RRRR):</B><BR><INPUT TYPE="text" NAME="date" SIZE="65" MAXLENGTH="64" VALUE="<? echo date('d-m-Y', ($vytiahnutie['date'])); ?>"></TD></TR>
        <!-- //<TR><TD ALIGN="center"><B>OBRAZOK</B> (max. velk. 64kB):<BR><INPUT TYPE="file" NAME="pic" SIZE="50" VALUE="<?// echo $vytiahnutie['pic'] ?>"></TD></TR> -->
        <TR><TD ALIGN="center"><B>PRECITANE:</B><BR><INPUT TYPE="text" NAME="precitane" SIZE="65" VALUE="<? echo $vytiahnutie['precitane']; ?>"></TD></TR>
        <TR><TD ALIGN="center" ><B>TEXT HLAVICKA:</B><BR><TEXTAREA NAME="text_small" COLS="77" ROWS="4"><? echo $vytiahnutie['text_small']; ?></TEXTAREA></TD></TR>
        <TR><TD ALIGN="center" ><B>HLAVNY TEXT:</B><BR><TEXTAREA NAME="text_big" COLS="77" ROWS="15"><? echo $vytiahnutie['text_big']; ?></TEXTAREA></TD></TR>
        <TR><TD ALIGN="center"><INPUT TYPE="hidden" NAME="id" VALUE="<? echo $vytiahnutie['id']; ?>"><INPUT TYPE="submit" VALUE="Upravit Clanok"></TD>
       </FORM>
      </TABLE>
      <?
    ...
    ?>
      <TABLE BORDER="1" ALIGN="center" BORDERCOLOR="black">
       <FORM ACTION="admin_clanky_update.php?x=3" METHOD="post">
        ...
        <? if ( $_SESSION['typ_uzivatela'] == "admin" ) {?>
          <TR><TD ALIGN="center"><B>AUTOR:</B><BR><INPUT TYPE="text" NAME="author" SIZE="65" MAXLENGTH="128" VALUE="<? echo $_POST['author']; ?>"></TD></TR>
        <? } 
         if ( $_SESSION['typ_uzivatela'] == "moderator" ) {?>
           <TR><TD ALIGN="center"><B>AUTOR:</B><BR><INPUT TYPE="hidden" NAME="author" SIZE="65" MAXLENGTH="128" VALUE="<? echo $_POST['author']; ?>"><? echo $_POST['author']; ?></TD></TR>
         <? } ?>
        
        <TR><TD ALIGN="center"><B>NADPIS CLANKU:</B><BR><INPUT TYPE="text" NAME="nadpis" SIZE="65" MAXLENGTH="128" VALUE="<? echo $_POST['nadpis']; ?>"></TD></TR>
        <TR><TD ALIGN="center"><B>DATUM (DD-MM-RRRR):</B><BR><INPUT TYPE="text" NAME="date" SIZE="65" MAXLENGTH="64" VALUE="<? echo date('d-m-Y', ($_POST['date'])); ?>"></TD></TR>
        <!-- //<TR><TD ALIGN="center"><B>OBRAZOK</B> (max. velk. 64kB):<BR><INPUT TYPE="file" NAME="pic" SIZE="50" VALUE="<?// echo $vytiahnutie['pic'] ?>"></TD></TR> -->
        <TR><TD ALIGN="center"><B>PRECITANE:</B><BR><INPUT TYPE="text" NAME="precitane" SIZE="65" VALUE="<? echo $_POST['precitane']; ?>"></TD></TR>
        <TR><TD ALIGN="center"><B>TEXT HLAVICKA:</B><BR><TEXTAREA NAME="text_small" COLS="77" ROWS="4"><? echo $_POST['text_small']; ?></TEXTAREA></TD></TR>
        <TR><TD ALIGN="center"><B>HLAVNY TEXT:</B><BR><TEXTAREA NAME="text_big" COLS="77" ROWS="15"><? echo $_POST['text_big']; ?></TEXTAREA></TD></TR>
        <TR><TD ALIGN="center"><INPUT TYPE="hidden" NAME="id" VALUE="<? echo $_POST['id']; ?>"><INPUT TYPE="submit" VALUE="Upravit Clanok"></TD>
       </FORM>
      </TABLE>
    <?
  } else if ( $x == "3" ){
