...
// -------------------------------------------------------------------------- //
  ...
  $hard = strip_tags($hard,'');
    ...
    ?>
      ...
      <SPAN CLASS="cursor" ONCLICK="window.open('admin_pictures_delete.php?x=<? echo $tabulka; ?>&amp;y=<? echo $stlpec; ?>&amp;z=<? echo $hodnota; ?>&amp;hard=1', '', 'toolbar=0,location=0,directories=0,status=0,menubar=0,scrollbars=1,resizable=0,width=300,height=320,left=10,titlebar=1'); window.close();"><B>ANO</B></SPAN>
      &nbsp;&nbsp;&nbsp;
