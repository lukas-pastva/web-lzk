      ...
      if ($x != null){
        ...
        if ($x == "1"){?>
          ...
          <DIV CLASS="obrazok_zorad">
            <FORM ACTION="site.php?x=<?php echo $odkaz; ?>" METHOD="post">
              ...
              <DIV CLASS="obrazok">
               <DIV CLASS="obrazok_1">
                <DIV CLASS="obrazok_nazov">
                 <B><?php echo $i.": ".$vyber["author"] ?></B>
                </DIV>
                <DIV CLASS="obrazok_popis">
                 <B>Datum:    </B><?php echo date('d-m-Y', ($vyber['date']))?><BR>
                 <B>Popis:    </B><?php echo $vyber["description"] ?><BR>
                </DIV>
                <DIV CLASS="obrazok_pic">
                 <DIV CLASS="cursor"  ONCLICK="window.open('viewer.php?sub_class=<?php echo $vyber['sub_class']; ?>&amp;order_by=4&amp;id=<?php echo $vyber['id']; ?>', '_blank', 'toolbar=0,location=0,directories=0,status=0,menubar=0,scrollbars=1,resizable=0,width=1000,height=600,left=10,titlebar=0');" TITLE="click"><IMG SRC="<?php echo $vyber["destination"]."small/".$vyber["name"]?>" WIDTH="133" HEIGHT="100" BORDER="1"></DIV>
                </DIV>
               </DIV>
